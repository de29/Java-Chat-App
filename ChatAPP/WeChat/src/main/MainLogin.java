...
public class MainLogin extends javax.swing.JFrame {
                ...
                try{   
                    ...
                    switch (msg) {
                        ...
                        case "Email already used":
                            showMessage(Message.MessageType.ERROR, "Email se trouve déjà!");
                            break;
    ...
    private void register() {
        ...
        if(user.getEmail().isEmpty()||user.getUserName().isEmpty()||user.getPassword().isEmpty()||user.getPassword2().isEmpty() ){
            showMessage(Message.MessageType.ERROR, "Remplissez les champs !");
        }else if(!isValid(user.getEmail())){
            showMessage(Message.MessageType.ERROR, "Email invalide !");
        }else if (!user.getPassword().equals(user.getPassword2())){
            showMessage(Message.MessageType.ERROR, "Mots de passe incorrecte!");
        }else{
            try{
