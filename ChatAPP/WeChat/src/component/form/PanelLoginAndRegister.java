...
public class PanelLoginAndRegister extends javax.swing.JLayeredPane {
    ...
    private void initRegister(ActionListener eventRegister){
        ...
        txt2Pass.setHint(" Reecrire mot de passe");
        register.add(txt2Pass,"w 60%");
        
        Button cmd =new Button();
        cmd.setForeground(new Color(0,0,0));
        cmd.setBackground(new Color(255,255,255));
        cmd.setEffectColor(new Color (118, 99, 222));
        cmd.addActionListener(eventRegister);
        cmd.setText("S'enregistrer");
        cmd.setFocusable(false);
        register.add(cmd,"w 40%, h 40");
        register.setBackground(new Color(149,189,255));
    ...
    private void initLogin(ActionListener eventLogin){
        ...
        JLabel label=new JLabel("Bienvenue sur WeChat");
        label.setFont(new Font("sansserif", 1, 50));
        label.setForeground(new Color(255,255,255));
        login.add(label);
    ...
    private void initComponents() {
        ...
        login.setBackground(new java.awt.Color(149, 189, 255));
