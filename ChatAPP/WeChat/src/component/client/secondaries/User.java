...
//chat.Ctitle.getUserName();
    ...
    private void initComponents() {
        ...
        Avatar.setImage(new javax.swing.ImageIcon(getClass().getResource("/icon/usr.png"))); // NOI18N

        onlineIcon.setForeground(new java.awt.Color(102, 102, 102));
        onlineIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/offline.png"))); // NOI18N
        Avatar.add(onlineIcon);
        onlineIcon.setBounds(40, 40, 20, 20);
