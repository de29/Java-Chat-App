...
public class HMAC {
    ...
    try {
        // Add this line to register the Bouncy Castle security provider
         ...
         System.out.println("certif : "+certificate);
         ...
         byte[] calculatedHMAC = hexToBytes(calculateHMAC(message, key));
     
        System.out.println("calculated : " + calculateHMAC(message, key));
        return MessageDigest.isEqual(receivedHMACBytes, calculatedHMAC);
